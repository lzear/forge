...
export const interopDefault = async <T>(
  ...
  const module_ = (resolved as { default?: unknown }).default ?? resolved
  ...
  if ((module_ as { __esModule?: boolean }).__esModule) {
    const inner = (module_ as { default?: unknown }).default
    if (inner !== undefined) return inner as any
  }
  return module_ as any
}
